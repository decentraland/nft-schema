...
export declare type TraitDefinition = {
...
export declare type TraitInstance = {
    /** identifier i.e. "dcl:avatar-speed" */
    id: string;
    /** Value of the trait */
    value?: any;
 ...
 */
export declare type DARRegister = {
